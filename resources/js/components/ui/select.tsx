        ...
        <SelectPrimitive.Portal>
            ...
            >
                <SelectPrimitive.Popup
                    ...
                    className={cn(
                        "bg-popover text-popover-foreground relative z-50 min-w-(--anchor-width) origin-(--transform-origin) overflow-hidden rounded-md border shadow-md data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
                        className
                    )}
                    {...props}
                >
                    ...
                    <SelectPrimitive.List
                        ...
                        className={cn(
                            "max-h-[min(calc(var(--available-height)---spacing(9)),calc(--spacing(72)))] scroll-py-1 overflow-y-auto p-1"
                        )}
                    >
                        {children}
                    </SelectPrimitive.List>
